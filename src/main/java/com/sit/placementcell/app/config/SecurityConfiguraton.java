...
//                                .requestMatchers(GET, UrlFor.allStudents).hasAnyAuthority("ROLE_STUDENT","ROLE_STAFF","ROLE_ADMIN")
                                ...
                                .requestMatchers(PUT,UrlFor.uploadStatus).permitAll()

                                .requestMatchers(POST,UrlFor.uploadProof).permitAll()

                                .requestMatchers(GET,UrlFor.findAllJobApplications).permitAll()
                                .anyRequest()
                                .authenticated()
                )
