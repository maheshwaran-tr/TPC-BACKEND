...
public class UrlFor {
    ...
    static final String uploadStatus = "sit/admin/update-status";

    // proof urls
    static final String uploadProof = "sit/proofs/upload-img";

    static final String findAllJobApplications = "sit/applications/all";
}